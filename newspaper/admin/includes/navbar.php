<nav class="navbar navbar-expand-lg navbar-dark p-3" style="background: linear-gradient(135deg, #4A90E2 0%, #1ABC9C 100%);">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto align-items-lg-center">
      ...
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center" href="articles_from_students.php">
          <span>Student Articles</span>
          <?php
       ...
       <li class="nav-item">
        <a class="nav-link d-flex align-items-center" href="edit_requests.php">
